...
function nsuFindChar(s_989857427, sub_989857428, start_989857429, last_989857430) {
    var Temporary1;

  var result_989857431 = 0;
  ...
  BeforeRet: {
    ...
    F.line = 1946;
    if ((last_989857430 < 0)) {
    Temporary1 = (s_989857427).length - 1;
    }
    else {
    Temporary1 = last_989857430;
    }
    
    var last_989857432 = Temporary1;
    Label2: {
      F.line = 1949;
      var iHEX60gensym176_989857446 = 0;
      F.line = 75;
      F.filename = "iterators_1.nim";
      var colontmp__973078647 = 0;
      F.line = 1949;
      F.filename = "strutils.nim";
      colontmp__973078647 = start_989857429;
      F.line = 90;
      F.filename = "iterators_1.nim";
      ...
      Label3: {
        F.line = 91;
          Label4: while (true) {
          if (!(res_973078648 <= last_989857432)) break Label4;
            F.line = 1963;
            F.filename = "strutils.nim";
            iHEX60gensym176_989857446 = res_973078648;
            if ((s_989857427[chckIndx(iHEX60gensym176_989857446, 0, (s_989857427).length - 1)] == sub_989857428)) {
            F.line = 1951;
            result_989857431 = iHEX60gensym176_989857446;
            break BeforeRet;
            }
  ...
  return result_989857431;

}

function nsuFindStrA(a_989857405, s_989857406, sub_989857407, start_989857408, last_989857409) {
    var Temporary1;

  var result_989857410 = 0;
  ...
  BeforeRet: {
    ...
    F.filename = "strutils.nim";
    if ((last_989857409 < 0)) {
    Temporary1 = (s_989857406).length - 1;
    }
    else {
    Temporary1 = last_989857409;
    }
    
    var last_989857411 = Temporary1;
    F.line = 1906;
    var subLast_989857412 = subInt((sub_989857407).length, 1);
    if ((subLast_989857412 == (-1))) {
    F.line = 1911;
    result_989857410 = start_989857408;
    break BeforeRet;
    }
    ...
    result_989857410 = (-1);
    F.line = 1916;
    var skip_989857413 = start_989857408;
    Label2: {
      F.line = 1918;
        Label3: while (true) {
        if (!(subLast_989857412 <= subInt(last_989857411, skip_989857413))) break Label3;
          F.line = 1919;
          var i_989857414 = subLast_989857412;
          Label4: {
            F.line = 1920;
              Label5: while (true) {
              if (!(s_989857406[chckIndx(addInt(skip_989857413, i_989857414), 0, (s_989857406).length - 1)] == sub_989857407[chckIndx(i_989857414, 0, (sub_989857407).length - 1)])) break Label5;
                if ((i_989857414 == 0)) {
                F.line = 1922;
                result_989857410 = skip_989857413;
                break BeforeRet;
                }
                
                F.line = 1923;
                i_989857414 = subInt(i_989857414, 1);
              }
          };
          F.line = 1924;
          skip_989857413 = addInt(skip_989857413, a_989857405[chckIndx(s_989857406[chckIndx(addInt(skip_989857413, subLast_989857412), 0, (s_989857406).length - 1)], 0, (a_989857405).length - 1)]);
        }
    };
  };
  framePtr = F.prev;

  return result_989857410;
...
function nsuInitSkipTable(a_989857362, sub_989857363) {
  ...
  framePtr = F;
    ...
    Label1: {
      ...
      F.line = 1881;
      F.filename = "strutils.nim";
      colontmp__973078653 = subInt(m_989857364, 1);
      F.line = 119;
      F.filename = "iterators_1.nim";
      var i_973078654 = 0;
      Label2: {
...
function nsuInitNewSkipTable(sub_989857402) {
  var result_989857403 = [new Int32Array(256)];

  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/nim/nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1891;
    F.filename = "strutils.nim";
    nsuInitSkipTable(result_989857403[0], sub_989857402);
  framePtr = F.prev;

  return result_989857403[0];

}

function nsuFindStr(s_989857464, sub_989857465, start_989857466, last_989857467) {
  var result_989857468 = 0;

  var F = {procname: "strutils.find", prev: framePtr, filename: "/home/runner/work/nim/nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    if ((subInt((s_989857464).length, start_989857466) < (sub_989857465).length)) {
    F.line = 2003;
    F.filename = "strutils.nim";
    result_989857468 = (-1);
    break BeforeRet;
    ...
    if (((sub_989857465).length == 1)) {
    F.line = 2004;
    result_989857468 = nsuFindChar(s_989857464, sub_989857465[chckIndx(0, 0, (sub_989857465).length - 1)], start_989857466, last_989857467);
    break BeforeRet;
    }
    
    F.line = 2007;
    result_989857468 = nsuFindStrA(nsuInitNewSkipTable(sub_989857465), s_989857464, sub_989857465, start_989857466, last_989857467);
  };
  framePtr = F.prev;

  return result_989857468;

}

function contains_989857606(s_989857607, sub_989857608) {
  var result_989857609 = false;
  ...
  BeforeRet: {
    F.line = 2161;
    F.filename = "strutils.nim";
    result_989857609 = (0 <= nsuFindStr(s_989857607, sub_989857608, 0, (-1)));
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_989857609;
...
function HEX3Aanonymous_973078602(r_973078603) {
  ...
  BeforeRet: {
    ...
    if (!(contains_989857606(cstrToNimstr(reason_973078562.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 249;
